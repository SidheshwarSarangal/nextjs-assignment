  ...
  return (
    <div className="w-full flex flex-wrap mx-auto md:mx-0 items-center justify-start px-4 py-0 bg-white text-2xl lg:text-4xl">
      ...
      <div className="flex flex-wrap gap-4 sm:gap-6 md:gap-10 items-center justify-start">
        <button className="group min-w-[120px] l flex items-center space-x-2 bg-gray-200 hover:bg-yellow-200 text-black px-4 py-2 rounded-lg transition-all duration-300 ease-in-out shadow-sm">
        ...
        <button className="group min-w-[120px] flex items-center space-x-2 bg-gray-200 hover:bg-yellow-200 text-black px-4 py-2 rounded-lg transition-all duration-300 ease-in-out shadow-sm">
        ...
        <button className="group min-w-[120px] flex items-center space-x-2 bg-gray-200 hover:bg-yellow-200 text-black px-4 py-2 rounded-lg transition-all duration-300 ease-in-out shadow-sm">
          ...
          <span className="text-base sm:text-lg md:text-xl">Cart</span>
        </button>
      </div>
    </div>
  );
